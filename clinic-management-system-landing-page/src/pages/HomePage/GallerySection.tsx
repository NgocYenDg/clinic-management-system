...
const HIGHLIGHTED_TICKETS = [
    {
        ...
        name: 'Khám tổng quát',
        description: 'Dịch vụ khám sức khỏe tổng quát giúp kiểm tra toàn diện các chỉ số cơ bản của cơ thể như tim mạch, huyết áp, đường huyết, mỡ máu, chức năng gan – thận. Kết hợp với siêu âm và xét nghiệm cần thiết, bác sĩ sẽ đánh giá tình trạng sức khỏe và đưa ra phác đồ theo dõi phù hợp.'
    },
    {
                    ...
                    {HIGHLIGHTED_TICKETS.map(ticket => (
                        <div key={ticket.name} className="flex flex-col overflow-hidden rounded-3xl">
                            ...
                            <div className="flex flex-1 flex-col gap-[26px] bg-white p-[35px]">
                                ...
                                <Link to="/book-appointment" className="mt-auto">
                                    <div className="text-primary font-semibold tracking-widest uppercase">
                                        Đặt lịch ngay <FontAwesomeIcon icon={faArrowRight} />
                                    </div>
                                </Link>
